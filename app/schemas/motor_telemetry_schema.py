...
#     timestamp: int = Field(
#         ...,
#         description="Device timestamp in milliseconds or seconds",
#     )
...
#     is_live: int = Field(
#         ...,
#         description="1 = live packet, 0 = offline EEPROM packet",
#     )
...
#             raise ValueError(
#                 "status_code must be one of: 1 Forward Running, 2 Reverse Running, 3 Standby, 4 Fault, 5 Power Off"
#             )
